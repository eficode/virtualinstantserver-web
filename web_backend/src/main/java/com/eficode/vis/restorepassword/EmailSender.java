...
public class EmailSender extends Thread{
    ...
    private static final String sender = "superawesomeemailserver@gmail.com";
    private static final String host = "smtp.gmail.com";
    private final Properties properties;
    private final Session session;
    private static final String USER_NAME = "superawesomeemailserver";
    private static final String PASSWORD = "Awesome!@#";
